...
const HireMe = () => {
  return (
    <div className="fixed md:absolute bottom-6 left-6 flex items-center justify-center overflow-visible md:left-8 xs:left-0 md:right-auto md:-top-[105px] md:bottom-auto z-10  pointer-events-none select-none">
