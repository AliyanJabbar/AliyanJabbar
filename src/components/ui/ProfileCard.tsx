...
import styles from "../moduleCSS/profile-card.module.css";
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl = "/assets/ProfilePic.png",
  iconUrl,
  grainUrl,
  behindGradient,
  innerGradient,
  ...
  const handlePointerEnter = useCallback(() => {
    ...
    wrap.classList.add(styles["active"] || "active");
    card.classList.add(styles["active"] || "active");
  }, [animationHandlers]);
  ...
  const handlePointerLeave = useCallback(
    (event: PointerEvent) => {
      ...
      wrap.classList.remove(styles["active"] || "active");
      card.classList.remove(styles["active"] || "active");
    },
    [animationHandlers]
  );
