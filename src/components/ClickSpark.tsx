...
const ClickSpark: React.FC<ClickSparkProps> = ({
  ...
  // Determine spark color based on theme if not explicitly provided
  const effectiveSparkColor = useCallback(() => {
    return sparkColor || (resolvedTheme === "dark" ? "#fff" : "#333");
  }, [sparkColor, resolvedTheme]);
  ...
  }, [sparkSize, sparkRadius, sparkCount, duration, easeFunc, extraScale, effectiveSparkColor]);
