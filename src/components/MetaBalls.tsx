...
// Add edge fading function
float getEdgeFade(vec2 coord, vec2 resolution) {
    vec2 normCoord = coord / resolution;
    vec2 centered = 2.0 * normCoord - 1.0;
    float dist = length(centered);
    float edgeWidth = 0.1;
    return smoothstep(1.0 - edgeWidth, 0.9, dist);
}
...
void main() {
    ...
    // Apply edge fading
    float edgeFade = 1.0 - getEdgeFade(fc, iResolution.xy);
    f *= edgeFade;
