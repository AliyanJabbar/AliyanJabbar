                    ...
                    <div className="space-y-3 w-full">
                      {suggestedQuestions.map((question, index) => (
                        <button
                          ...
                          className="w-full p-2 dark:bg-grayish bg-gray-300 dark:hover:bg-[#2b2b2b] hover:bg-gray-200 dark:text-white text-black rounded-full transition-colors duration-150 text-sm font-light text-center select-none"
                        >
                          {question}
                        </button>
                      ))}
                        ...
                        <div
                          className={`px-5 py-3 text-sm rounded-2xl max-w-[75%] ${
                            msg.role === "user"
                              ...
                              : "dark:bg-grayish bg-gray-300 dark:text-light text-dark rounded-tl-none"
                          }`}
                        >
                          {msg.text}
                        </div>
